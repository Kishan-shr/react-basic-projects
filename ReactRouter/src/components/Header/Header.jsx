...
//                                 to="/"
//                                     className={({isActive}) =>
//                                         `flex py-2 pr-4 pl-3 duration-200 ${isActive ? "text-orange-700" : "text-gray-700"} border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 hover:text-orange-700 lg:p-0 `
//                                     }
//                                 >
//                                     Home
//                                 </NavLink>  
        ...
        <header className="shadow sticky z-50 top-0 bg-white">
            <nav className="border-gray-200 px-4 lg:px-6 py-2.5">
                <div className="flex justify-between items-center mx-auto max-w-screen-xl">
                    ...
                    {/* Nav Items */}
                    <ul className="flex lg:flex flex-row space-x-8 font-medium">
                        <li>
                            <NavLink
                                to="/"
                                className={({ isActive }) =>
